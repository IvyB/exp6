...
public class GourmetCoffeeGUI extends JPanel {
    ...
    class AddModifyListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (catalogList.isSelectionEmpty() ) {
                JOptionPane.showMessageDialog(null, "请选中产品后再点击按钮", "警告",  JOptionPane.ERROR_MESSAGE);

            }else {
                try {
                    quantity=Integer.parseInt(quantityTextField.getText());
                    if (quantity<=0) {
                        JOptionPane.showMessageDialog(null, "产品数量应为正数", "警告",  JOptionPane.ERROR_MESSAGE);
                    }
                    else {
                        String code = (String) catalogList.getSelectedValue();
                        Product product = catalog.getProduct(code);
                    ...
                    JOptionPane.showMessageDialog(null, "产品数量必须为整数", "警告",  JOptionPane.ERROR_MESSAGE);
                }
            }
    ...
    class RemoveListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (currentOrder.getNumberOfItems()==0) {
                JOptionPane.showMessageDialog(null, "您尚未购买任何产品", "警告",  JOptionPane.ERROR_MESSAGE);
            }else if (orderList.isSelectionEmpty()) {
                JOptionPane.showMessageDialog(null, "您尚未选中任何产品", "警告",  JOptionPane.ERROR_MESSAGE);
    ...
    class SaveSalesListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (sales.getNumberOfOrders()==0) {
                JOptionPane.showMessageDialog(null, "没有购买记录", "警告",  JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    ...
                    //oous.writeObject(content);//把文档写入文件中
                    fileWriter = new FileWriter(file);
                    fileWriter.write(content);

                } catch (NullPointerException ex) {
                    JOptionPane.showMessageDialog(null, "请选择文件", "警告",  JOptionPane.ERROR_MESSAGE);
                }
                catch (IOException e) {
                    JOptionPane.showMessageDialog(null, "文件无法被创建或者打开", "警告",  JOptionPane.ERROR_MESSAGE);
                }finally {
                    try {
                        //fous.close();
                        fileWriter.close();
